...
class ImagePicker {
  ...
  @visibleForTesting
  static ImagePickerPlatform get platform {
    final pickerInstance = ImagePickerPlatform.instance;
    if (pickerInstance is ImagePickerAndroid) {
      pickerInstance.useAndroidPhotoPicker = true;
    }
